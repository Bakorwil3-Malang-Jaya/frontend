...
export const ConfirmDeleteUsers = ({ pickIdDelete, deleteUsersId }) => {
  return (
    <div>
      <dialog id="my_modal_confirmDeleteUsers" className="modal">
        <form method="dialog" className="modal-box">
          <div className=" flex flex-col items-center justify-center">
            ...
            <div className="flex gap-4">
              <button
                onClick={() => {
                  window.my_modal_confirmDeleteUsers.close();
                }}
              ...
              <button
                onClick={() => deleteUsersId(pickIdDelete)}
